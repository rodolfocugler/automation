...
public:
  ...
  static void controlLedTv() {
    if (turnLedTVOffCounter == 1) {
      Log::printf("[turnLedTVOffCounter] %d\n", turnLedTVOffCounter);
      turnLedTVOffCounter--;
